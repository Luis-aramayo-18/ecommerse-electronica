        ...
        <div className="mt-10 lg:ms-16 lg:mt-0 w-full lg:w-[40%] lg:max-w-[450px]">
            ...
            <div>
              <div>
                ...
                <p className="mt-3 text-light lowercase first-letter:uppercase text-[#deecfb]">
                  {product.description}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 mt-5">
                <button
                  className="flex justify-center transition-all duration-100 text-[#aaadb1] bg-gray-900 p-4 border-2 border-[#a5a8ac] lg:hover:bg-[#fea401] lg:hover:shadow-md lg:hover:text-white lg:hover:border-white"
                  style={{
